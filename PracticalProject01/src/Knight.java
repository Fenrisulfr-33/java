...
public class Knight extends MOB {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("TESTING Knight, Name: " + knight.getName()); // Should return: Black Knight
        System.out.println("TESTING Knight, MaxHP: " + knight.getMaxHP()); // Should return: 400
        System.out.println("TESTING Knight, Armor: " + knight.getArmor()); // Should return: 200
        System.out.println("TESTING Knight, XP: " + knight.getXP()); // Should return: 10
        System.out.println("TESTING Knight, DamageDie: " + knight.getDamageDie()); // Should return: D12
        System.out.println("TESTING Knight, HitModifier: " + knight.getHitModifier()); // Should return: 1
        System.out.println("TESTING Knight, Active fortune: " + knight.getActiveFortune()); // Should return: null
        ...
        System.out.println("TESTING Knight, MaxHP after fortune: " + knight.getMaxHP()); // Should return: 500
        System.out.println("TESTING Knight, Armor after fortune: " + knight.getArmor()); // Should return: 250
        System.out.println("TESTING Knight, HitModifier after fortune: " + knight.getHitModifier()); // Should return: 2
        System.out.println("TESTING Knight, Monster killed +10 xp."); // Should return: 200
        knight.addXP(10);
