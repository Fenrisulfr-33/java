...
public class Main {
    ...
    private static String gameData = "PracticalProject01\\gamedata.csv"; // 
    // private static String saveData = "knights.csv"; // PracticalProject01\knights.csv
    private static String saveData = "PracticalProject01\\knights.csv";
