...
public class Moving {
    ...
    public void movingBoxes(String filename) {
        try {
            ...
            while (animals.hasNext()) {
                String next = animals.nextLine();
                String[] animalString = next.split(" ");
                String animalType = animalString[0];
                String animalName = animalString[1];
                if (animalType.equals("parrot")){
                    BirdsBox.add(new Parrot(animalName));
                }
                if (animalType.equals("toucan")){
                ...
                if (animalType.equals("lizard")){
                    ReptilesBox.add(new Lizard(animalName));
                }
                if (animalType.equals("gecko")){
    ...
    public static void main(String[] args) {
        ...
        // String file = "C:\\Users\\ArchB\\Documents\\coding\\java\\Lab06ZooZone\\src\\Animals.txt";
