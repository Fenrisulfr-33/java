...
public class EReader {
    ...
    public static void main(String[] args) {
        ...
        myBooks.add("Lab05BrokenEReader\\src\\Great_Gatsby.txt");
        myBooks.add("Lab05BrokenEReader\\src\\Alice_In_Wonderland.txt");
        myBooks.add("Lab05BrokenEReader\\src\\US_Constitution.txt");
